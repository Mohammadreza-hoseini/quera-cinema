...
class Users:
    ...
    def register():
        ...
        cursor.execute(
            f"INSERT INTO User(id, avatar, username, birth_date, phone_number, email, password,"
    ...
    def change_user_name(id: str) -> None:
        ...
        while user_validation in validate_username_dict:
            ...
            new_user_name = input("Enter new username: ")
            user_validation = Users.validate_user_name(new_user_name)
        cursor.execute(f"UPDATE User SET username='{new_user_name}' where id='{id}'")
        connection.commit()
    ...
    def change_password(id: str) -> None:
        ...
        validate_password_new_password = {
            -1: "enter password",
